...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( 'post' == $post->post_type ) : // Hide post-type and comments info for pages on search results ?>
		<a href="<?php the_permalink(); ?>" class="post-format image" title="Permalink"><?php _e('Permalink', 'piha') ?></a>
	<?php endif; ?>
	...
	<div class="entry-wrap">	
		...
		<footer class="entry-meta">
			<p><span><?php _e('Image:', 'piha') ?></span> <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'piha' ), the_title_attribute( 'echo=0' ) ); ?>"><?php the_title(); ?></a>
